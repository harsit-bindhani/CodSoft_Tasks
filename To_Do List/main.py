...
button=Button(frame,text="ADD",font="arial 20 bold",width=6,bg="#458B74",fg="#fff",bd=0,command=addTask)
...
listbox=Listbox(frame1,font=('arial',13),width=40,height=16,bg="#53868B",fg="white",cursor="hand2",selectbackground="#5a95ff")
